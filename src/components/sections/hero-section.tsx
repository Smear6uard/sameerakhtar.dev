...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div
        className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[300px] sm:w-[400px] md:w-[500px] h-[200px] sm:h-[250px] md:h-[300px] bg-gradient-to-r from-accent/[0.35] via-accent/[0.22] to-transparent rounded-full blur-3xl pointer-events-none"
        aria-hidden="true"
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              costs $0.002. That&apos;s a 6-stage AI pipeline processing your
              wardrobe for less than a penny.
            </motion.p>
