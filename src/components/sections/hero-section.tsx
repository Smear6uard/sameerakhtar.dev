          ...
          <div ref={contentRef} className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              >
                ...
                costs <span className="text-accent font-mono font-semibold">$0.002</span>.
                That&apos;s a 5-stage ML pipeline — from wardrobe scan to styled outfit — shipped to
                the App Store in 8 weeks.
              </motion.p>
