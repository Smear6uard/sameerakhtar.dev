    ...
    <div className="absolute inset-0">
      ...
      {!ready && (
        <div className="absolute inset-x-0 bottom-16 flex flex-col items-center gap-2 px-6">
          <span className="font-mono text-[10.5px] tracking-[0.14em] uppercase text-[rgba(244,239,230,0.7)]">
            Starting camera · loading model (~7 MB)
          </span>
          <span className="relative block h-px w-40 overflow-hidden bg-[rgba(244,239,230,0.15)]">
            <span
              className="absolute inset-y-0 left-0 w-1/3 bg-[#ffb86b]"
