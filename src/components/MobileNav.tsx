...
export function MobileNav() {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-bg-primary/95 backdrop-blur-md border-t border-white/5"
    ...
    >
      <div className="flex items-center justify-around h-16 px-2">
        ...
        <a
          ...
          className="flex flex-col items-center justify-center gap-1 px-4 py-2 text-accent"
        >
        ...
        <button
          onClick={toggleTheme}
          className="flex flex-col items-center justify-center gap-1 px-4 py-2 text-text-muted hover:text-accent transition-colors"
